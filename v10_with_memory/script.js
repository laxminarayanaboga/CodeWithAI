document.addEventListener("DOMContentLoaded", function() {
    ...
    const validateForm = () => {
        ...
        if (today.getFullYear() - dobDate.getFullYear() < 18 || (today.getFullYear() - dobDate.getFullYear() === 18 && today.getMonth() < dobDate.getMonth()) || (today.getFullYear() - dobDate.getFullYear() === 18 && today.getMonth() === dobDate.getMonth() && today.getDate() < dobDate.getDate())) {
            isValid = false;
